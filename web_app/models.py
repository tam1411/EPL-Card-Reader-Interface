...
class Admin(Manager):
    ...
    def promoteManager(self, lucky_user):
        new_mgr = Manager(id=lucky_user.id, firstname=lucky_user.firstname,
                          lastname=lucky_user.lastname, email=lucky_user.lastname, active=True)
    ...
    def promoteAdmin(self, lucky_mgr):
        new_admin = Manager(id=lucky_mgr.id, firstname=lucky_mgr.firstname,
                            lastname=lucky_mgr.lastname, email=lucky_mgr.email, active=True)
